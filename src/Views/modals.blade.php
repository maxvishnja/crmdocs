...
<!-- Modal Rename Folders and Files -->
<div class="modal fade fill-in" id="modalPerm" tabindex="-1" role="dialog" aria-labelledby="modalFillInLabel" aria-hidden="true">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
        <i class="pg-close"></i>
    </button>
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-3 text-center">
                        <button type="button" id="perm-folder" class="btn btn-primary btn-lg btn-large fs-15">Set</button>
                    </div>
                </div>
